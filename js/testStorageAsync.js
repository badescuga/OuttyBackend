...
var longStr = require('./testLongString');
...
console.log('testing storage stuff');
...
{
console.log('starting query all --- ');
await queryAllEntitiesAsync();

console.log('starting insert entity --- ');
await insertEntityAsync(entity3);
}
...
async function queryAllEntitiesAsync()
{
  try{
    var data = await testQueryAllEntitiesAsync();
    console.log('finished await querry: '+JSON.stringify(data));
  }
  catch (err)
  {
...
async function testQueryAllEntitiesAsync()
{
...
async function insertEntityAsync(entity)
{
   try{
    var data = await testInsertEntityAsync(entity);
    console.log('finished await insert: '+JSON.stringify(data));
  }
  catch (err)
  {
...
async function testInsertEntityAsync(entity) {
